...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=40, lastline=77]{PS02_answerKey.R}  
	\footnotesize
	\begin{verbatim}
$statistic
[1] 3.791168
...
Lower_Class  -0.3220306       1.6419565            -1.5230259
	...
	\lstinputlisting[language=R, firstline=79, lastline=80]{PS02_answerKey.R}  
	\footnotesize
	\begin{verbatim}
	...
	\lstinputlisting[language=R, firstline=82, lastline=83]{PS02_answerKey.R}  
...
\begin{figure}[h!]
	...
	\includegraphics[width=1.1\textwidth]{../template/women_desc.png}
\end{figure}		
\newpage
\begin{enumerate}
...
%	\vspace{.05cm}
	...
	After we load our dataset into our working environment, we execute our regression model in which the number of new or repaired water facilities is explained by whether there are reserved seats for female leaders. We then investigate the estimated coefficients of the model using \texttt{summary()}.\\
					...
					\vspace{.15cm}
	\lstinputlisting[language=R, firstline=89, lastline=94]{PS02_answerKey.R}  
	\begin{footnotesize}
...
F-statistic: 5.493 on 1 and 320 DF,  p-value: 0.0197
	...
	Having reserved seats for female politicians increase the number drinking water facilities in the villages, by 9.2 units, on average. The estimated coefficient is statistically differentiable from zero at the $\alpha=0.05$ level because the p-value $<$ 0.05 ($\approx $0.02).
\end{enumerate}
%
%\newpage
...
%	 
%	 \vspace{.15cm}
%	 \lstinputlisting[language=R, firstline=100, lastline=107]{PS02_answerKey.R}  
%	 
%		\begin{verbatim}
...
% \vspace{.15cm}
%\lstinputlisting[language=R, firstline=110, lastline=113]{PS02_answerKey.R}  
%	
%\begin{figure}[h!]\centering
...
%\vspace{.25cm}
%
%\lstinputlisting[language=R, firstline=115, lastline=116]{PS02_answerKey.R}  
%
%		\begin{verbatim}
%[1] 0.6364835
%		\end{verbatim}
...
%	\vspace{.15cm}
%	
%	\lstinputlisting[language=R, firstline=118, lastline=121]{PS02_answerKey.R}  
%		\vspace{.25cm}
%
%
...
%						\vspace{.15cm}
%			\lstinputlisting[language=R, firstline=123, lastline=132]{PS02_answerKey.R}  
%			\vspace{.25cm}
%			
...
%					\vspace{.15cm}
%					\lstinputlisting[language=R, firstline=134, lastline=135]{PS02_answerKey.R}  
%					
%	\end{itemize}
%			\vspace{6cm}
...
%	
%		\vspace{.15cm}
%	\lstinputlisting[language=R, firstline=137, lastline=146]{PS02_answerKey.R}  
%			\vspace{.15cm}
...
%	\lstinputlisting[language=R, firstline=148, lastline=165]{PS02_answerKey.R}  
%
%\begin{figure}[h!]\centering
